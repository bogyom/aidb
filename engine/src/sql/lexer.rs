...
fn keyword_or_literal(ident: &str) -> KeywordOrLiteral {
    match ident.to_ascii_uppercase().as_str() {
        ...
        "SIGNED" => KeywordOrLiteral::Keyword(Keyword::Signed),
        "DECIMAL" => KeywordOrLiteral::Keyword(Keyword::Decimal),
        ...
        "DIV" => KeywordOrLiteral::Keyword(Keyword::Div),
        ...
        "GROUP" => KeywordOrLiteral::Keyword(Keyword::Group),
        "HAVING" => KeywordOrLiteral::Keyword(Keyword::Having),
        ...
        "DISTINCT" => KeywordOrLiteral::Keyword(Keyword::Distinct),
        "CROSS" => KeywordOrLiteral::Keyword(Keyword::Cross),
        "JOIN" => KeywordOrLiteral::Keyword(Keyword::Join),
        "LEFT" => KeywordOrLiteral::Keyword(Keyword::Left),
        "OUTER" => KeywordOrLiteral::Keyword(Keyword::Outer),
        "INNER" => KeywordOrLiteral::Keyword(Keyword::Inner),
